      ...
      <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          <div class="dropdown-header text-center">
            ...
            <p class="mb-1 mt-3 font-weight-semibold"><?php echo Session::get('username');?></p>
            <p class="font-weight-light text-muted mb-0"> <?php echo Session::get('email') ?></p>
          </div>
          ...
          ?>
          <a class="dropdown-item" href="?action=logout ">Sign Out<i class="dropdown-item-icon ti-power-off"></i></a>
        </div>
      </li>
    </ul>
